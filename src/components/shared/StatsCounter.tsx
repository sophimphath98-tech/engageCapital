...
function StatCounterItem({ value, numericValue, suffix, prefix = "", label }: CounterProps) {
...
export default function StatsCounter() {
  const stats = [
    { id: "1", value: "120", numericValue: 120, prefix: "$", suffix: "M+", label: "Loans Disbursed" },
    { id: "2", value: "25000", numericValue: 25000, prefix: "", suffix: "+", label: "Borrowers Served" },
    { id: "3", value: "2", numericValue: 2, prefix: "", suffix: " hrs", label: "Avg. Approval Time" },
    { id: "4", value: "0", numericValue: 0, prefix: "", suffix: "%", label: "Hidden Fees" },
    { id: "5", value: "4.9", numericValue: 49, prefix: "", suffix: "★", label: "Customer Rating" }
  ];
